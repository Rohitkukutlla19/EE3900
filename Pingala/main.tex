...
\begin{lstlisting}
wget https://github.com/Rohitkukutlla19/EE3900/blob/main/Pingala/codes/1.py
\end{lstlisting}
...
\begin{lstlisting}
wget https://github.com/Rohitkukutlla19/EE3900/blob/main/Pingala/codes/2_1.py
\end{lstlisting}
\begin{figure}[!htp]
...
Download the Python code using
\begin{lstlisting}
wget https://github.com/Rohitkukutlla19/EE3900/blob/main/Pingala/codes/2_2.py
\end{lstlisting}
\begin{figure}[!htbp]
