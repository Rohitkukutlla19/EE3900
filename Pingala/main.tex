...
\begin{lstlisting}
wget https://raw.githubusercontent.com/samar2605/EE3900/master/Pingala/codes/1.py
\end{lstlisting}
...
\begin{lstlisting}
wget https://raw.githubusercontent.com/samar2605/EE3900/master/Pingala/codes/2_1.py
\end{lstlisting}
\begin{figure}[!htp]
...
Download the Python code using
\begin{lstlisting}
wget https://github.com/samar2605/EE3900/blob/master/Pingala/codes/2_2.py
\end{lstlisting}
\begin{figure}[!htbp]
...
\eqref{pr:1-2}, \eqref{pr:1-3}, \eqref{pr:1-4}. Therefore, options 2, 2,
