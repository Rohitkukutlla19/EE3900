...
\begin{lstlisting}
wget https://github.com/Rohitkukutlla19/EE3900/blob/main/Pingala/codes/2.1.py
\end{lstlisting}
\begin{figure}[!htp]
    \includegraphics[width=\columnwidth]{figs/2.1.png}
    \caption{Plot of $x(n)$}
    \label{fig:xn}
\end{figure}
\newpage
...
Download the Python code using
\begin{lstlisting}
wget https://github.com/akhilgattu02/EE3900/blob/master/Pingala/codes/2_2.py
\end{lstlisting}
\begin{figure}[!htbp]
